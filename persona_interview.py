...
def is_question_redundant(question: str, profile_keywords: set) -> bool:
    ...
    confirmation_signals = [
        ...
        r"\byour company'?s name",
        r"\bcan you (tell me|share|provide) (your )?(company|organization)",
        r"\bcould you (tell me|share|provide) (your )?(company|organization)",
        r"\bconfirm your company",
        r"\bstate your company",
        r"\bremind me (of |which |what )?(your )?(company|organization)",
        ...
        r"\bwhat (is|are|'s) your (current |professional )?title",
        r"\bwhat (is|are|'s) your (current |professional )?role",
        r"\bwhat is (the )?name of your (title|position|role)",
        r"\byour (title|position|role)'?s? name",
        r"\bcan you (tell me|share|provide) (your )?(title|position|role)",
        r"\bcould you (tell me|share|provide) (your )?(title|position|role)",
        r"\bconfirm (your |what your )?(current |professional )?title",
        r"\bstate your (current |professional )?title",
        r"\bcould you confirm (what )?your (current |professional )?title",
        r"\bremind me (of |what |which )?(your )?(current |professional )?title",
